function [final_aoa,final_series,final_min_mse,windowWithMinMSE,optimalKforWindow] = MSSA_L1_findOptimalWandK_filtering_onetime_theta_min_mse(noisy_series,clean_series,num_antennas,true_aoa,wLower,wUpper,hankMode,orientation)
