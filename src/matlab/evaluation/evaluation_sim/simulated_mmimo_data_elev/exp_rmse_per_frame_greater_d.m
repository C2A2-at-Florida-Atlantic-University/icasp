...
for c = clients 
    ...
    for f = 1:19
        ...
        for s = 1:128
            ...
            [svd_final_aoa,svd_final_series,svd_final_max_magnitude,svd_windowWithMinMSE,svd_optimalKforWindow] = MSSA_SVD_findOptimalWandK_filtering_onetime_max_magnitude(data_matrix(:,s),num_antennas,true_aoa_client,2,5,1,'s',step);
...
for r = ref 
    ...
    for f = 1:19
        ...
        for s = 1:128
            ...
            %[l1_final_aoa,l1_final_series,l1_final_max_magnitude,l1_windowWithMinMSE,l1_optimalKforWindow] = MSSA_L1_findOptimalWandK_filtering_onetime_max_magnitude(data_matrix(:,s),num_antennas,true_aoa,2,5,1,'s',step);
            [svd_final_aoa,svd_final_series,svd_final_max_magnitude,svd_windowWithMinMSE,svd_optimalKforWindow] = MSSA_SVD_findOptimalWandK_filtering_onetime_max_magnitude(data_matrix(:,s),num_antennas,true_aoa_ref,2,5,1,'s',step);
