...
close all
%% Parameters %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Location5_TrueTheta = [27.88];    %Direction of arrival (Degree)
T = 128;   % Samples
K = length(Location5_TrueTheta); %The number of signal source
f = 3.55e9;
...
for k=1:K 
    A(:,k) = exp(-1j*2*pi*d_x*sind(Location5_TrueTheta(k))*(0:Nr-1)'/lambda); 
end 
%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
     Location5_Frame1 = A*s+noise;      %Insert AWGN 
save Location5_Frame1
save Location5_TrueTheta
