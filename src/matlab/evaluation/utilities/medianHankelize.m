function hankelizedMatrix = medianHankelize(matrix)
%hankelize the given vector by filling the anti-diagonals with the median
...
for col = (-numRows+1):0
    ...
    c(abs(col)+1)= median(antidiagonal);
end
