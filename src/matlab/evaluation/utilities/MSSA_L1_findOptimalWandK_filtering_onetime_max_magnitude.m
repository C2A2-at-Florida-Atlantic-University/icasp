function [final_aoa,final_series,final_max_magnitude,windowWithMinMSE,optimalKforWindow] = MSSA_L1_findOptimalWandK_filtering_onetime_max_magnitude(noisy_series,num_antennas,true_aoa,wLower,wUpper,hankMode,orientation,step)
...
%input: 
    ...
    %step: step for scanning vector...ex. every one degree 
...
for window = wLower : wUpper
    ...
    for k = 1 : window
        ...
        denoised_series = MSSA_GoHank_L1_Denoising(real_imag,window,k,2,orientation,hankMode);
